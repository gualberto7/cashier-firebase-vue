...
<template>
  <div class="min-h-screen flex items-center justify-center bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full space-y-8">
      <div>
        <h1 class="text-center text-3xl font-bold text-primary-600">Cashier</h1>
      ...
      <form class="mt-8 space-y-6" @submit.prevent="handleSubmit">
        <div v-if="error || passwordError" class="rounded-md bg-red-50 p-4">
          <p class="text-sm text-red-700">{{ error || passwordError }}</p>
        </div>
